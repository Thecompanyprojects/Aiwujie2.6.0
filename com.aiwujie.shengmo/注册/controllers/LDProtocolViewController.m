...
- (void)viewDidLoad {
    ...
    if ([self.type intValue] == 1) {
        ...
        [web loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",URL,@"index.php/Home/info/vipregagreement"]]]];
        
    }else{
    
        [web loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",URL,@"Home/info/regagreement"]]]];
