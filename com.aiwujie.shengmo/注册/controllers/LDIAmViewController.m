...
-(void)status{
    ...
    if (self.along.length != 0 && self.experience.length != 0 && self.culture.length != 0 && self.monthly.length != 0 && self.introduce.length != 0) {
        ...
        [self.completeButton setBackgroundColor:CDCOLOR];
...
-(void)ButtonClick:(UIButton *)button{
    ...
    if (_level.length == 0 || _want.length == 0) {
        ...
        NSString *lat = [NSString string];
        
        NSString *lng = [NSString string];
        
        NSString *city = [NSString string];
        
        NSString *addr = [NSString string];
        ...
        NSURL* url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@",URL,@"Api/Users/registernewrd"]];
