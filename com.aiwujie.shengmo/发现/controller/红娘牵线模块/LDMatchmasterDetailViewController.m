...
-(void)createPersonInformationData{
    ...
    NSString *url = [NSString stringWithFormat:@"%@%@",URL,@"Api/Matchmaker/getMatchUserInfo"];
    ...
    [manager POST:url parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        if (integer != 2000) {
            ...
            [_dataDic setValuesForKeysWithDictionary:responseObject[@"data"]];
           
            [self createHeaderView:responseObject[@"data"]];
...
//    if ([[[NSUserDefaults standardUserDefaults] objectForKey:@"match_state"] intValue] > 0 || [[[NSUserDefaults standardUserDefaults] objectForKey:@"is_admin"] intValue] == 1) {
//
//         nameLabel.text = dic[@"nickname"];
//
//    }else{
//
//        nameLabel.text = @"昵称牵线会员可见";
//    }
