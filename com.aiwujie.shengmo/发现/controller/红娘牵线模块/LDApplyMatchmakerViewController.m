...
-(void)createHeaderView{
    ...
    NSString *url = [NSString stringWithFormat:@"%@%@",URL,@"Api/Matchmaker/getUserCenterHeader"];
    ...
    [manager POST:url parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        if (integer == 2000) {
            ...
            [self.headerImageView sd_setImageWithURL:[NSURL URLWithString:responseObject[@"data"][@"head_pic"]] placeholderImage:[UIImage imageNamed:@"红娘未知图片"]];
            
            self.headerNameLabel.text = responseObject[@"data"][@"nickname"];
            
            if ([responseObject[@"data"][@"realname"] intValue] == 1) {
            ...
            }else if([responseObject[@"data"][@"match_state"] intValue] == 1){
                
                self.headerServiceLabel.text = @"资料待完善";
                
            }else if([responseObject[@"data"][@"match_state"] intValue] == 2){
                
                self.headerServiceLabel.text = @"资料审核中";
                
            }else if([responseObject[@"data"][@"match_state"] intValue] == 3){
                
                self.headerServiceLabel.text = @"正在牵线服务中";
                
            }else if([responseObject[@"data"][@"match_state"] intValue] == 4 || [responseObject[@"data"][@"match_state"] intValue] == 5){
            ...
            if ([responseObject[@"data"][@"role"] isEqualToString:@"S"]) {
                
                self.sexualLabel.text = @"斯";
                
                self.sexualLabel.backgroundColor = BOYCOLOR;
                
            }else if ([responseObject[@"data"][@"role"] isEqualToString:@"M"]){
                
                self.sexualLabel.text = @"慕";
                
                self.sexualLabel.backgroundColor = GIRLECOLOR;
                
            }else if([responseObject[@"data"][@"role"] isEqualToString:@"SM"]){
            ...
            }else if ([responseObject[@"data"][@"sex"] intValue] == 2){
            ...
            if (![responseObject[@"data"][@"city"] isEqual:[NSNull null]] && ![responseObject[@"data"][@"province"] isEqual:[NSNull null]]) {
                
                if([responseObject[@"data"][@"city"] length] != 0){
                    
                    if ([responseObject[@"data"][@"city"] isEqualToString:responseObject[@"data"][@"province"]]) {
                        
                        self.cityLabel.text = responseObject[@"data"][@"city"];
                        
                    }else{
                        
                        if ([responseObject[@"data"][@"province"] length] != 0) {
                            
                            self.cityLabel.text = [NSString stringWithFormat:@"%@ %@",responseObject[@"data"][@"province"],responseObject[@"data"][@"city"]];
                            
                        }else{
                            
                            self.cityLabel.text = [NSString stringWithFormat:@"%@",responseObject[@"data"][@"city"]];
                        }
                    }
...
-(void)createServiceData{
    ...
    NSString *url = [NSString stringWithFormat:@"%@%@",URL,@"Api/Matchmaker/getMatchmakerInfo"];
...
-(void)getStep3PresentData{
    ...
    NSString *url = [NSString stringWithFormat:@"%@%@",URL,@"Api/Matchmaker/getMatchObList"];
...
-(void)getStep3IntroduceData{
    ...
    NSString *url = [NSString stringWithFormat:@"%@%@",URL,@"Api/Matchmaker/getMatchMakerIntroduce"];
    ...
    [manager POST:url parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        if (integer == 2000) {
            ...
            _stemp3IntroduceStr = [NSString stringWithFormat:@"%@",responseObject[@"data"][@"match_makerintroduce"]];
...
-(void)getStep2Data{
    ...
    NSString *url = [NSString stringWithFormat:@"%@%@",URL,@"Api/Matchmaker/getStep2Info"];
...
//        NSLog(@"%@",responseObject);
        ...
        if (integer == 2000) {
            ...
            if ([responseObject[@"data"][@"match_introduce"] length] == 0 && [responseObject[@"data"][@"match_photo"] count] == 0) {
                ...
                [self.stemp2Dic setDictionary:responseObject[@"data"]];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([_recordStep intValue] == 1) {
        ...
        if (indexPath.section == 0){
            ...
            _cellH = cell.contentView.frame.size.height + picScrollH - 25.5;
...
-(void)showOrHiddenPic:(UIButton *)button{
    ...
    if (button.tag == 20) {
        ...
        url = [NSString stringWithFormat:@"%@%@",URL,@"Api/Matchmaker/setPhotoLock/method/0"];
        
    }else if(button.tag == 21){
        
        url = [NSString stringWithFormat:@"%@%@",URL,@"Api/Matchmaker/setPhotoLock/method/1"];
        
    }else{
        
        url = [NSString stringWithFormat:@"%@%@",URL,@"Api/Matchmaker/setPhotoLock/method/2"];
    }
...
-(void)serviceButtonClick:(UIButton *)button{
    ...
    if (button.tag - 9 <= _serviceArray.count) {
        ...
        conversationVC.targetId = [NSString stringWithFormat:@"%@",_serviceArray[button.tag - 10][@"uid"]];
        conversationVC.mobile = [NSString stringWithFormat:@"%@",_serviceArray[button.tag - 10][@"uid"]];
        conversationVC.title = [NSString stringWithFormat:@"%@",_serviceArray[button.tag - 10][@"nickname"]];
