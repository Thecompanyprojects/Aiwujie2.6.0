...
-(void)backButtonOnClick:(UIButton *)button{
    ...
    parameters = @{@"uid":[[NSUserDefaults standardUserDefaults] objectForKey:@"uid"],@"lat":@"",@"lng":@"",@"login_uid":[[NSUserDefaults standardUserDefaults] objectForKey:@"uid"]};
...
-(void)createDatatype:(NSString *)type{
    ...
    parameters = @{@"page":[NSString stringWithFormat:@"%d",_tablePage],@"layout":@"1",@"type":@"4"};
       //NSLog(@"%@",parameters);
