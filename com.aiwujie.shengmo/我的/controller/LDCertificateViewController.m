...
- (IBAction)noPublicButtonClick:(id)sender {
    ...
    if ([_status intValue] != 0) {
        ...
        NSString *url = [NSString stringWithFormat:@"%@%@",URL,@"Api/Power/setRealnameState/status/nobody"];
...
- (IBAction)vipLookButtonClick:(id)sender {
    ...
    if ([_status intValue] != 1) {
        ...
        NSString *url = [NSString stringWithFormat:@"%@%@",URL,@"Api/Power/setRealnameState/status/vip"];
...
- (IBAction)submitButtonClick:(id)sender {
    ...
    if ([self.type intValue] == 2) {
        ...
        if (_headUrl.length == 0) {
            ...
            NSString *url = [NSString stringWithFormat:@"%@%@",URL,@"Api/Power/replaceidcard"];
            
            NSDictionary *parameters = [NSDictionary dictionary];
            
            parameters = @{@"uid":[[NSUserDefaults standardUserDefaults] objectForKey:@"uid"],@"card_replace":_headUrl};
        ...
        NSString *url = [NSString stringWithFormat:@"%@%@",URL,@"Api/Other/setidcard"];
        ...
        parameters = @{@"uid":[[NSUserDefaults standardUserDefaults] objectForKey:@"uid"],@"card_face":_headUrl};
