...
-(void)rightButtonOnClick{
    ...
    UIAlertAction * action = [UIAlertAction actionWithTitle:@"删除已上传语音" style:UIAlertActionStyleDefault  handler:^(UIAlertAction * _Nonnull action) {
        ...
        url = [NSString stringWithFormat:@"%@%@",URL,@"Api/users/mediaDel"];
...
-(void)backButtonOnClick{
    ...
    if (_recordedTmpFile == nil) {
        ...
        UIAlertAction * action = [UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault  handler:^(UIAlertAction * _Nonnull action) {
            ...
            [manager POST:[NSString stringWithFormat:@"%@%@",URL,@"Api/Api/MediaUpload"] parameters:nil constructingBodyWithBlock:^(id<AFMultipartFormData>  _Nonnull formData) {
...
-(void)createMediaData:(NSString *)media{
    ...
    [manager POST:[NSString stringWithFormat:@"%@%@",URL,@"Api/users/MediaEdit"]  parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
