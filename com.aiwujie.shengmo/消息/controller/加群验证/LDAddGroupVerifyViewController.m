...
-(void)backButtonOnClick:(UIButton *)button{
    ...
    [manager POST:[NSString stringWithFormat:@"%@%@",URL,@"Api/friend/getIntoGroupOne"] parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
