...
//        LDGroupSpuarePageViewController *v3 = [[LDGroupSpuarePageViewController alloc] init];
//        LDGroupSpuarePageViewController *v4 = [[LDGroupSpuarePageViewController alloc] init];
...
//        
//    }else if ([viewController.content intValue] == 4){
//    
//        return 1;
//        
...
-(void)createNavButtn{
    ...
    //最新
//    _newestButton = [[UIButton alloc] initWithFrame:CGRectMake(_navView.frame.size.width/4, 27,_navView.frame.size.width/4, 30)];
//    _newestButton.tag = 101;
//    [_newestButton setTitle:@"最新" forState:UIControlStateNormal];
//    _newestButton.titleLabel.font = [UIFont systemFontOfSize:17];
//    [_newestButton addTarget:self action:@selector(navButtonClick:) forControlEvents:UIControlEventTouchUpInside];
//    [_newestButton setTitleColor:[UIColor lightGrayColor] forState:UIControlStateNormal];
//    [_navView addSubview:_newestButton];
//    
//    _newestView = [[UIView alloc] initWithFrame:CGRectMake(_navView.frame.size.width/4 + _navView.frame.size.width/8 - 3, 55, 6, 6)];
//    _newestView.tag = 201;
//    _newestView.backgroundColor = [UIColor colorWithRed:183/255.0 green:58/255.0 blue:203/255.0 alpha:1];
//    _newestView.layer.cornerRadius = 3;
//    _newestView.hidden = YES;
//    _newestView.clipsToBounds = YES;
//    [_navView addSubview:_newestView];
//    
//    //最新按钮右上方红点
//    _newestDogLabel = [[UILabel alloc] initWithFrame:CGRectMake(_navView.frame.size.width/2 - _navView.frame.size.width/8 + 12, 24, 16, 16)];
...
//    
//    //附近
//    _hotButton = [[UIButton alloc] initWithFrame:CGRectMake(_navView.frame.size.width/4 * 2, 27,_navView.frame.size.width/4, 30)];
//    [_hotButton setTitle:@"附近" forState:UIControlStateNormal];
//    _hotButton.tag = 102;
...
//    
//    _hotView = [[UIView alloc] initWithFrame:CGRectMake(_navView.frame.size.width/4 * 2 + _navView.frame.size.width/8 - 3, 55, 6, 6)];
//    _hotView.backgroundColor = [UIColor colorWithRed:183/255.0 green:58/255.0 blue:203/255.0 alpha:1];
//    _hotView.tag = 202;
...
-(void)createSearchView{
    ...
    imageArray = @[@"查看全部",@"查看全部"];
    
    titleArray = @[@"查看全部群组",@"根据性取向展示感兴趣的群组"];
...
-(void)createGroupButtonOnClick{
    ...
    if ([[[NSUserDefaults standardUserDefaults] objectForKey:@"is_admin"] intValue] == 1 || [[[NSUserDefaults standardUserDefaults] objectForKey:@"vip"] intValue] == 1) {
        ...
        NSString *url = [NSString stringWithFormat:@"%@%@",URL,@"Api/friend/addGroup"];
