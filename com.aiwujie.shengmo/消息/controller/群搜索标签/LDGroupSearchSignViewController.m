...
//    _dataArray = [[NSMutableArray alloc] initWithArray:@[@[@"推荐关键词",@"3",@"4",@"5",@"6",@"7"],@[@"生活休闲"],@[@"省市地区"],@[@"同好人群"],@[@"斯慕爱好"],@[@"其他分类"]]];
...
-(void)createSignData{
    ...
    NSString *url = [NSString stringWithFormat:@"%@%@",URL,@"Api/friend/getGroupSearchText"];
